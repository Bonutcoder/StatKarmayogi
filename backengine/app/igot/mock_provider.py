...
MOCK_CATALOGUE: List[Dict] = [
    ...
    },
    {
        ...
        "modules": ["1. Base Year & Weighting Diagram", "2. Price Data Scrutiny", "3. Index Aggregation Formulas"],
    ...
    },
    {
        ...
        "competency_ids": ["comp_survey_methodology", "comp_data_quality"],
        "level": 3,
        "duration_hours": 12.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. PLFS Schedule Concepts", "2. Activity Status Matrix", "3. CAPI Software & Validation"],
        "target_audience": "Senior Field Investigators & Survey Supervisors",
        "prerequisites": ["National Sample Survey Design & Methodology"],
    },
    {
        "id": "crs_py_002",
        "title": "Advanced Statistical Computing & Automated Report Generation",
        "provider": "National Statistical Systems Training Academy (NSSTA)",
        "competency_ids": ["comp_python", "comp_data_visualization"],
        "level": 3,
        "duration_hours": 15.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. SciPy & Statsmodels", "2. Complex Aggregation Pipelines", "3. PDF/HTML Report Generation"],
    ...
    },
    {
        ...
        "provider": "Data Analytics Wing, MoSPI",
        "competency_ids": ["comp_machine_learning"],
        "level": 4,
        "duration_hours": 16.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. Text Preprocessing & Embeddings", "2. NIC Code Classification", "3. Model Fine-Tuning & Evaluation"],
    ...
    },
    {
        ...
        "modules": ["1. Satellite Raster Data Basics", "2. NDVI & Crop Masking", "3. Acreage & Yield Estimation"],
        "target_audience": "Agricultural Statistical Officers & Analysts",
        "prerequisites": ["Geospatial Data Integration & GIS"],
    },
    {
        "id": "crs_qual_002",
        ...
        "modules": ["1. Outlier Identification Models", "2. Imputation Strategies", "3. Audit Logging & Certification"],
        "target_audience": "Statistical Quality Audit Teams & Supervisors",
        "prerequisites": ["National Quality Assurance Framework (NQAF)"],
    },
    {
        "id": "crs_cs_ai_001",
        ...
        "modules": ["1. Transformer Fundamentals & Attention", "2. Vector Embeddings & RAG", "3. Llama-3 & Mistral Fine-Tuning"],
        "target_audience": "AI Engineers, System Architects & Technical Leads",
        "prerequisites": ["Machine Learning Fundamentals", "Python for Statistical Data Processing"],
    },
    {
        "id": "crs_cs_fs_001",
        ...
        "competency_ids": ["comp_python", "comp_digital_governance"],
        "level": 2,
        "duration_hours": 24.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. React State & UI Components", "2. FastAPI Routing & Async ORM", "3. JWT Authentication & Security"],
        "target_audience": "Full Stack Software Developers & IT Officers",
        "prerequisites": ["Basic Computer Literacy", "Python Data Structures"],
    },
    {
        "id": "crs_cs_ds_001",
        "title": "Big Data Analytics & Distributed Computing with PySpark",
        "provider": "Data Analytics Wing, MoSPI & C-DAC",
        "competency_ids": ["comp_statistics", "comp_python", "comp_machine_learning"],
        "level": 3,
        "duration_hours": 20.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. PySpark RDDs & DataFrames", "2. Distributed Feature Engineering", "3. Spark MLlib Pipelines"],
    ...
    },
    {
        ...
        "competency_ids": ["comp_digital_governance", "comp_python"],
        "level": 3,
        "duration_hours": 16.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. Docker Containerization", "2. Kubernetes Deployment Patterns", "3. CI/CD & Automated Testing"],
    ...
    },
    {
        ...
        "modules": ["1. Image Preprocessing & OCR", "2. Deep Learning for Layout Parsing", "3. Document Data Extraction"],
    ...
    # --- CYBERSECURITY & INFORMATION SECURITY ---
    {
        ...
        "modules": ["1. Threat Landscape & Phishing", "2. Network Defense Basics", "3. CERT-In Incident Reporting"],
    ...
    },
    {
        ...
        "modules": ["1. OWASP Top 10 Exploits", "2. Vulnerability Assessment", "3. Secure Code Remediation"],
    ...
    },
    {
        ...
        "competency_ids": ["comp_digital_governance", "comp_data_quality"],
        "level": 3,
        "duration_hours": 10.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. ISMS Policy Framework", "2. Risk Assessment Matrix", "3. Internal Audit Execution"],
    ...
    },
    {
        ...
        "modules": ["1. Zero-Trust Pillars", "2. OAuth 2.0 & SAML Protocols", "3. Access Policy Automation"],
        "target_audience": "Enterprise Security Architects & System Administrators",
        "prerequisites": ["Ethical Hacking & Security Auditing"],
    },
    {
        "id": "crs_sec_005",
        ...
        "modules": ["1. SOC Triage & Alert Analysis", "2. Digital Forensic Preservation", "3. Incident Containment & Recovery"],
    ...
    },
    {
        ...
        "modules": ["1. DPDP Act 2023 Legal Framework", "2. Consent Management Architecture", "3. Anonymization & De-identification"],
        "target_audience": "Data Protection Officers, Directors & Legal Advisors",
        "prerequisites": ["None"],
    },
    # --- MANAGEMENT & LEADERSHIP FOR CIVIL SERVICES ---
    {
        "id": "crs_mgmt_001",
        ...
        "modules": ["1. Rule to Role Mindset Shift", "2. Stakeholder Engagement", "3. Driving Innovation in Government"],
    ...
    },
    {
        ...
        "modules": ["1. RFP & Tender Drafting", "2. Agile Project Execution", "3. SLA Monitoring & Risk Mitigation"],
        "target_audience": "Project Directors & Procurement Managers",
        "prerequisites": ["Public Sector Leadership"],
    },
    {
        "id": "crs_mgmt_003",
        ...
        "competency_ids": ["comp_statistics", "comp_digital_governance"],
        "level": 3,
        "duration_hours": 10.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. Policy Formulation Cycle", "2. Statistical Evidence Synthesis", "3. Impact Evaluation Methods"],
    ...
    },
    {
        ...
        "modules": ["1. GFR 2017 Key Provisions", "2. GeM Portal Bidding & Direct Purchase", "3. Financial Scrutiny & Auditing"],
    ...
    },
    {
        ...
        "modules": ["1. ACBP Framework Drafting", "2. KPI Setting & Goal Tracking", "3. Constructive Feedback & Coaching"],
    ...
    },
    {
        ...
        "modules": ["1. Press Release Drafting for Data Releases", "2. Crisis Communication", "3. Data Storytelling for Media"],
    ...
    },
    {
        ...
        "modules": ["1. Risk Identification & Taxonomy", "2. Likelihood & Impact Matrix", "3. Business Continuity Planning"],
    ...
    },
    {
        ...
        "modules": ["1. Negotiation Styles & Strategies", "2. Inter-agency Bottleneck Removal", "3. Consensus Building"],
    ...
    # --- COMPUTER SCIENCE & SOFTWARE ENGINEERING ---
    {
        ...
        "modules": ["1. Schema Normalization & ER Diagrams", "2. Indexing Strategies (B-Tree, GIN, GiST)", "3. Query Plan Optimization"],
    ...
    },
    {
        ...
        "modules": ["1. REST Resource Modeling", "2. OpenAPI 3.0 Specs & Validation", "3. Rate Limiting & Error Standard"],
    ...
    },
    {
        ...
        "modules": ["1. Unit Testing with Pytest", "2. Fixtures & Mocking", "3. Code Coverage & Static Analysis"],
    ...
    },
    {
        ...
        "modules": ["1. Linux Command Line Mastery", "2. Advanced Bash Scripting", "3. Systemd Services & Automation"],
    ...
    },
    {
        ...
        "modules": ["1. Git Core Concepts & Commits", "2. Branching & Merging Strategies", "3. Pull Request Review Workflows"],
    ...
    },
    {
        ...
        "competency_ids": ["comp_data_visualization", "comp_digital_governance"],
        "level": 2,
        "duration_hours": 8.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. GIGW 3.0 & WCAG Principles", "2. ARIA Accessibility markup", "3. Automated Accessibility Auditing"],
    ...
    },
    {
        ...
        "modules": ["1. MeghRaj Architecture & Services", "2. VM & Virtual Network Provisioning", "3. Load Balancing & Auto-scaling"],
    ...
    },
    {
        ...
        "provider": "Data Analytics Wing, MoSPI",
        "competency_ids": ["comp_python", "comp_data_quality"],
        "level": 3,
        "duration_hours": 18.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. Data Warehouse Star & Snowflake Schema", "2. Apache Airflow DAG Authoring", "3. ETL Data Validation & Recovery"],
        "target_audience": "Data Engineers & Statistical Pipeline Developers",
        "prerequisites": ["Python for Statistical Data Processing"],
    },
    # --- ADVANCED DATA SCIENCE, AI/ML & ANALYTICS ---
    {
        "id": "crs_cs_ai_003",
        ...
        "modules": ["1. PyTorch Tensors & Autograd", "2. Deep Neural Networks", "3. Model Evaluation & Transfer Learning"],
    ...
    },
    {
        ...
        "modules": ["1. PowerBI Data Ingestion", "2. DAX Expressions & Relationships", "3. Dashboard Interactivity & Design"],
        "target_audience": "Data Analysts & Reporting Officers",
        "prerequisites": ["Basic Data Visualization"],
    },
    {
        "id": "crs_cs_ai_004",
        ...
        "modules": ["1. MLflow Tracking & Registry", "2. Model Containerization & API Serving", "3. Data Drift & Retraining Automation"],
        "target_audience": "MLOps Engineers & Senior AI Developers",
        "prerequisites": ["Generative AI & LLM Architecture"],
    },
    {
        "id": "crs_cs_ds_003",
        "title": "Spatial Statistics & Spatial Econometrics with R",
        "provider": "NSSTA & Indian Statistical Institute (ISI) Kolkata",
        "competency_ids": ["comp_gis", "comp_statistics"],
        "level": 3,
        "duration_hours": 12.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. Spatial Autocorrelation & Moran's I", "2. Spatial Regression Models", "3. Kriging & Hotspot Analysis"],
        "target_audience": "Spatial Analysts & Senior Statisticians",
        "prerequisites": ["Geospatial Data Integration"],
    },
    {
        "id": "crs_cs_ai_005",
        "title": "AI Ethics, Algorithmic Bias Detection & Explainable AI (XAI)",
        "provider": "NITI Aayog AI Taskforce & MeitY",
        "competency_ids": ["comp_machine_learning", "comp_digital_governance"],
        "level": 3,
        "duration_hours": 8.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. SHAP & LIME Feature Attribution", "2. Fairness Metrics & Bias Auditing", "3. Responsible AI Governance"],
        "target_audience": "AI Ethicists, Data Scientists & Policy Directors",
        "prerequisites": ["Machine Learning Fundamentals"],
    },
    # --- STATISTICS, SURVEY METHODOLOGY & QUALITY ---
    {
        "id": "crs_stat_004",
        "title": "Small Area Estimation (SAE) Methods for District-Level Indicators",
        "provider": "NSSTA & Indian Statistical Institute (ISI)",
        "competency_ids": ["comp_statistics", "comp_survey_methodology"],
        "level": 4,
        "duration_hours": 14.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. Direct vs Indirect Estimators", "2. Fay-Herriot SAE Modeling", "3. MSE Estimation & Validation"],
    ...
    },
    {
        ...
        "modules": ["1. Record Linkage Algorithms", "2. Entity Resolution & Fellegi-Sunter Model", "3. Disclosure Control"],
        "target_audience": "Statistical Officers & Data Governance Teams",
        "prerequisites": ["National Sample Survey Design"],
    },
    {
        "id": "crs_qual_003",
        "title": "Data Governance, NDSAP Standards & Data Cataloging",
        "provider": "National Data Sharing & Accessibility Policy (NDSAP) Cell / NIC",
        "competency_ids": ["comp_data_quality", "comp_digital_governance"],
        "level": 2,
        "duration_hours": 7.0,
        "source": "iGOT Karmayogi (Verified Catalog)",
        ...
        "modules": ["1. NDSAP Principles & Guidelines", "2. DCAT Metadata Standards", "3. Publishing Open Datasets"],
